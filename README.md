...
- Install `brew`
  ...
  - install formulas
    ...
    ```
    brew install bat btop cava chafa diff-so-fancy eza fd figlet fzf gcc gh lolcat luarocks make mermaid-cli neovim pet pipx \
...
- Clone other `oh-my-zsh` plugins
    ...
    - `zsh-autosuggestions` omz method

      ```
      git clone https://github.com/zsh-users/zsh-autosuggestions ${ZSH_CUSTOM:-~/.oh-my-zsh/custom}/plugins/zsh-autosuggestions
      ```

    - `fast-syntax-highlighting` omz method
